...
final class AppBundleConfigurationTests: XCTestCase {
    ...
    func testRecordingOverlayUsesCompactIconOnlyHUD() throws {
        ...
        XCTAssertTrue(source.contains("LogoRecordingMark"))
        XCTAssertTrue(source.contains("AppLogoWaveShape"))
        XCTAssertTrue(source.contains("LiquidGlassHUDBackground"))
        ...
        XCTAssertTrue(source.contains("Color(red: 0.43, green: 1.0, blue: 0.94)"))
        XCTAssertTrue(source.contains("Color(red: 1.0, green: 0.56, blue: 0.30)"))
        XCTAssertTrue(source.contains("RoundedRectangle(cornerRadius: 24"))
        XCTAssertTrue(source.contains(".frame(width: 38, height: 34)"))
        XCTAssertTrue(source.contains(".frame(width: 104, height: 32)"))
        XCTAssertFalse(source.contains("GeneratedMicrophoneImage"))
        XCTAssertFalse(source.contains("MicrophoneIconFactory"))
        XCTAssertFalse(source.contains("RecordingStatusIcon"))
    ...
    func testRecordingOverlayWaveformUsesStaggeredAnimatedBars() throws {
        ...
        XCTAssertTrue(source.contains("Color(red: 0.67, green: 1.0, blue: 0.98)"))
        XCTAssertTrue(source.contains("Color(red: 0.18, green: 0.92, blue: 0.88)"))
        XCTAssertTrue(source.contains("Capsule().stroke(Color.white.opacity(0.26)"))
